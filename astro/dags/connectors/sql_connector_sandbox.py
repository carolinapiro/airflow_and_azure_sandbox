...
class SQLConnector():
    ...
    def query_database_processed_files(self) -> List[str]:
    ...
    def query_database_to_upload_files(self) -> List[str]:
    ...
    def insert_new_files(self, files_dict: dict):
    ...
    def update_status_for_uploaded_files(self, file: str):
